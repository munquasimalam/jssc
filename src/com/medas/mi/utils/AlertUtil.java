...
// 	    // ... user chose OK
// 		System.out.println(" if result.get():" +result.get().getText());
// 	} else {
// 		System.out.println(" else result.get():" +result.get().getText());
...
// 	}
 ...
 public static  String  choiceAlertPortName() {
	 	List<String> choices = new ArrayList<>();

	 	choices.add("COM8");
	 	choices.add("COM9");
	 
	 	ChoiceDialog<String> dialog = new ChoiceDialog<>("COM8", choices);
	 	dialog.setTitle(null);
	 	dialog.setHeaderText(null);
